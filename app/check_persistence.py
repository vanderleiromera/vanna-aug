        ...
        if os.path.exists(db_file):
            ...
            if os.path.exists(db_file):
                ...
                if size_after > size_before:
                    ...
                    print("Database file size did not increase, data may not be persisted")
            else:
    ...
    if collection:
        try:
            ...
            if count > 0:
                ...
                if results and 'documents' in results and results['documents']:
                    ...
                    for i, doc in enumerate(results['documents'][:5]):
                        ...
                        doc_id = results['ids'][i] if 'ids' in results and i < len(results['ids']) else "unknown"
            ...
            if query_results and 'documents' in query_results and query_results['documents']:
                print(f"Successfully found document: {query_results['documents'][0][0][:100]}...")
            else:
