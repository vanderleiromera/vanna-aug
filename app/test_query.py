...
def test_vendas_recentes():
    ...
    # Consulta para verificar se há vendas nos últimos 30 dias
    sql_vendas = """
    SELECT 
    ...
    FROM 
        sale_order 
    WHERE 
        date_order >= CURRENT_DATE - INTERVAL '30 days'
    """
    ...
    # Consulta para verificar produtos vendidos nos últimos 30 dias
    ...
    WHERE 
        so.date_order >= CURRENT_DATE - INTERVAL '30 days'
    GROUP BY 
        pt.name
    ORDER BY 
    ...
    print("\n=== Top 5 produtos vendidos nos últimos 30 dias ===")
    print(result)
    ...
    # Consulta para verificar produtos vendidos nos últimos 30 dias sem estoque
    sql_produtos_vendidos_sem_estoque = """
    SELECT
        pt.name AS produto,
        SUM(sol.product_uom_qty) AS total_vendido,
        COALESCE(SUM(sq.quantity), 0) AS estoque
    ...
    print("\n=== Produtos vendidos nos últimos 30 dias sem estoque ===")
    print(result)
